...
Реализвать в ручную следующие фильтры:
...
Написать и применить метод пагинации, который, кроме обычного вывода вернет количество страниц пагинации и номер текущей страницы [https://www.django-rest-framework.org/api-guide/pagination/#example](Это поможет)
